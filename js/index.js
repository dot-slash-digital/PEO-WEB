...
$(window).scroll(() => {
  ...
  if ($(window).width() > 449) {
    $(".parallax-slider").css({
      transform: "translateY( calc(" + scrollPos + "px * .6) )",
    });
...
function rotate() {
  if (currentSlide === 1) {
    $("#testimonials-container .testimonial:nth-child(1)").css({
      transform: "translate(0,0)",
    });
    $("#testimonials-container .testimonial:nth-child(2)").css({
      transform: "translate(100%,0)",
    });
    $("#testimonials-container .testimonial:nth-child(3)").css({
      transform: "translate(200%,0)",
    });
    $("#testimonials-container .testimonial:nth-child(4)").css({
      transform: "translate(300%,0)",
    });
    $("#testimonials-container .testimonial:nth-child(5)").css({
...
if (
  ...
  if (hour <= 8 || (hour == 16 && minute >= 1) || hour >= 17)
    // 12:00am - 8:59am, 4:01pm - 11:59pm
    currentlyClosed();
  else if (hour == 9)
    // 9:00am - 9:59am
    openingSoon("Soon");
  ...
  if (hour <= 8 || (hour == 14 && minute >= 1) || hour >= 15)
    // 12:00am - 8:59am, 2:01pm - 11:59pm
    currentlyClosed();
  else if (hour == 9)
    // 9:00am - 9:59am
    openingSoon("Soon");
    ...
    // 1:00pm - 2:00pm
    closingSoon("Soon");
} else if (day == "Sunday") currentlyClosed();
